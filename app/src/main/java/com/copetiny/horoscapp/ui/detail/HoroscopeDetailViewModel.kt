...
import com.copetiny.horoscapp.domain.model.HoroscopeModel
import com.copetiny.horoscapp.domain.model.PredictionModel
import com.copetiny.horoscapp.domain.usecase.GetPredictionUseCase
...
class HoroscopeDetailViewModel @Inject constructor(private val getPredictionUseCase: GetPredictionUseCase):ViewModel(){
    ...
    fun getHoroscope(sign: HoroscopeModel){
        ...
        viewModelScope.launch {
            ...
            val result:PredictionModel? = (Dispatchers.IO){getPredictionUseCase(sign.name)}
            if(result!=null){
